...
# lösche alle Zeilen, wo im Umsatz NA steht aber nur bis zum 01.08.2018
ourdata_fussball <- ourdata_fussball %>% 
  filter(!(is.na(Umsatz) & Datum <= as.Date("2018-08-01")))
...
# Testdatensatz (01.08.2018 bis 30.07.2019)
...
test_data_pred_ <- test_data_pred[-nrow(test_data_pred), ]
...
#valid_data_pred_ <- valid_data_pred_ %>%
...
write.csv(valid_data_pred_, "valid_data_pred_model_3.csv", row.names = FALSE)
