...
```{r}
train_csv <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/geordnet/train.csv?token=GHSAT0AAAAAACMWX4TNU5JZYA2G2UUPEFNKZM735OA")
# Hochladen von Test.csv
test_csv <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/geordnet/Datenvorbereitungcsv/test.csv?token=GHSAT0AAAAAACMWX4TMEQ2LUP4JTCI6JPM6ZM734SQ")
...
Daten <- data[Daten$Datum >= "2013-07-01" & Daten$Datum <= "2019-07-30", ]
