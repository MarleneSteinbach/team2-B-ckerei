...
Datenladen
```{r}
file_path <- file.path(getwd(), "Daten_imputed.csv")
...
valid_features_for_prediction <- test_data[, !names(test_data) %in% c('id')]

# Make predictions
valid_predictions <- predict(model_1, valid_features_for_prediction)
