...
```{r}
train_data$KielerWoche[is.na(train_data$KielerWoche)] <- 0

# Variable wochentag hinzufügen
train_data$Wochentag <- weekdays(train_data$Datum)

# Wochentag als faktor
train_data$Wochentag <- as.factor(train_data$Wochentag)
```
