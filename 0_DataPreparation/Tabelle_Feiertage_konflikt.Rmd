...
```{r}
model <- lm(Umsatz ~ Temperatur + Wettercode + Bewoelkung + Windgeschwindigkeit + as.factor(Warengruppe) + Fussballspiel + Ferien + Feiertag  + KielerWoche + as.factor(Wochentag) + Flohmarkt, data = train_data)
summary(model)
