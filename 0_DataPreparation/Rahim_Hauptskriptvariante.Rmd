...
```{r}
neue_ferientage_data <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/neue_ferientage_count.csv?token=GHSAT0AAAAAACMNUPXXM4HRJY4VUIXF7UPWZMYGO4A")
...
```{r}
Jahreszeiten <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/Jahreszeiten_Fruehling.csv?token=GHSAT0AAAAAACMNUPXXD3GUE32DYX2BMIJSZMYHPZQ")
...
```{r}
Kreuzfahrten <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/kreuzfahrtengesamt.csv?token=GHSAT0AAAAAACMNUPXX22C7RZUSYNZRMNJUZMYHS5Q")
...
write.csv(ourdata_fussball, "Gesamtdatensatz2.csv", row.names = FALSE)
```
