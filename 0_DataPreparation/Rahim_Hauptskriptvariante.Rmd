...
csvtest <- "https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/test.csv?token=GHSAT0AAAAAACMNUPXX3FGD3IXXQ3RYJENMZMZI7GQ"

wetter <- read.table(csvwetter, head=TRUE, sep = ",")
umdat <- read.csv(csvumsatzdaten_gekuerzt)
kiwo <- read.csv(csvkiwo)
testid <- read.csv(csvtest)
...
alle <- full_join(wetter, salesid, by = "Datum") %>%
...
```{r}
neue_ferientage_data <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/neue_ferientage_count.csv?token=GHSAT0AAAAAACMNUPXXFLLE4HFUOWGPKMMYZMZH7MQ")
...
```{r}
Jahreszeiten <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/Jahreszeiten_Fruehling.csv?token=GHSAT0AAAAAACMNUPXX4LSXPOSWGKIWBZ2AZMZIBKQ")
...
```{r}
Kreuzfahrten <- read.csv("https://raw.githubusercontent.com/MarleneSteinbach/team2-B-ckerei/main/0_DataPreparation/kreuzfahrten.csv?token=GHSAT0AAAAAACMNUPXWU4GZ3SRWAOR5LERWZMZICKA")
